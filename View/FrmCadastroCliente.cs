...
namespace SistemaAtendimento
{
    public partial class FrmCadastroCliente : Form
    {
        ...
        private async Task BuscarEnderecoporCep(string cep)
        {
            try
            {
                cep = cep.Replace("-", "").Trim(); //o replace tira o traço do cep e o trim tira os espaços
                ...
                using (HttpClient client = new HttpClient())
                {
                    ...
                    if (response.IsSuccessStatusCode)
                    {
                        ...
                        dynamic? dadosEndereco = JsonConvert.DeserializeObject<dynamic>(json);


                        if (dadosEndereco?.erro == true)

                        {
                            ExibirMensagem("CEP não encontrado ou invalido");
                            LimparCampos();
                    ...
                    {
                        ExibirMensagem("Não foi possivel consultar o CEP");
                    }
            ...
            {
                ExibirMensagem($"Erro ao buscar o CEP: {ex.Message}");
        ...
        {
            if (!string.IsNullOrEmpty(txtCep.Text)) //! significa que ele nao faz nada caso esteja vazio
            {
        ...
        {
            string termo = txtPesquisar.Text.Trim(); //o trim tira os espaços
